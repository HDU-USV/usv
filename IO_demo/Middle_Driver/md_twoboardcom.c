...
/*******************************函数声明****************************************
* 函数名称: void extra_pwm_value(uint8_t *buf)
* 输入参数:
* 返回参数:
* 功    能: 将PWM值数据提取出来
* 作    者: by 
...
uint8_t flag_heartbeat=0; //心跳包可以设置一个软件看门狗，定时监控状态
...
/*******************************函数声明****************************************
* 函数名称: void Com_TwoBoard_Msg_HeartBeat_Send(void)
* 输入参数:
* 返回参数:
* 功    能: 心跳包的发送，确定双方通道通信没有障碍。已固定频率发送。将安全开关的信号状态放在这个心跳包里
* 作    者: by 
* 日    期: 2017/12/18
*******************************************************************************/
...
/*******************************函数声明****************************************
* 函数名称: void Com_TwoBoard_Msg_RCinput_Send(uint8_t *rc_input)
* 输入参数:
* 返回参数:
* 功    能: 发送遥控器的解码数据组
* 作    者: by 
