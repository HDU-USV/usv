...
void Example_RCin_PWMout_Direct(void)
{
  ...
  uint16_t m_throttle = rc_pwm_in[2];
	uint16_t steering = rc_pwm_in[0];
	PWM_Set_Value_Channel_1(m_throttle+1500-steering);
	PWM_Set_Value_Channel_2(m_throttle+1500-steering);
	PWM_Set_Value_Channel_3(m_throttle+1500-steering);
	PWM_Set_Value_Channel_4(m_throttle+1500-steering);
	PWM_Set_Value_Channel_5(m_throttle+1500-steering);
	PWM_Set_Value_Channel_6(m_throttle+1500-steering);
	PWM_Set_Value_Channel_7(m_throttle+1500-steering);
	PWM_Set_Value_Channel_8(m_throttle-1500+steering);
}
