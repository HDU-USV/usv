...
from datasets import marine_to_tfrecords
...
tf.app.flags.DEFINE_string(
    'dataset_dir','/home/luobicangqiong/data/marine_dataset/train/',
    'Directory where the original dataset is stored.')
tf.app.flags.DEFINE_string(
    'output_name', 'marine',
    'Basename used for TFRecords output files.')
tf.app.flags.DEFINE_string(
    'output_dir', '/home/luobicangqiong/data/marine_dataset/train_record/',
...
def main(_):
    ...
    if FLAGS.dataset_name == 'marine':
        marine_to_tfrecords.run(FLAGS.dataset_dir, FLAGS.output_dir, FLAGS.output_name)
    else:
