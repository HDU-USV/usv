...
tf.app.flags.DEFINE_string(
    'checkpoint_path', '/home/luobicangqiong/models/VGG_VOC0712_SSD_300x300_ft_iter_120000.ckpt',
...
tf.app.flags.DEFINE_string(
    'dataset_dir', '/home/luobicangqiong/data/VOC2007_test/VOCdevkit/VOC2007_tfrecord/', 'The directory where the dataset files are stored.')
tf.app.flags.DEFINE_string(
...
def main(_):
    ...
    with tf.Graph().as_default():
        ...
        tf_utils.print_configuration(FLAGS.__flags, ssd_params, dataset.data_sources, FLAGS.eval_dir)
        # =================================================================== #
